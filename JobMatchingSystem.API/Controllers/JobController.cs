    ...
    public class JobController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateJob([FromBody] CreateJobRequest request)
        {
            ...
            return Ok(APIResponse<string>.Builder()
                ...
                .WithSuccess(true)
                .WithResult("Thêm job thành công")
                .Build());
        }
        ...
        public async Task<IActionResult> UpdateJob(int jobId, [FromBody] UpdateJobRequest request)
        {
            ...
            return Ok(APIResponse<string>.Builder()
                .WithStatusCode(HttpStatusCode.OK)
                .WithSuccess(true)
                .WithResult("Cập nhật job thành công")
                .Build());
        }
        ...
        public async Task<IActionResult> CensorJob(int jobId, [FromBody] CensorJobRequest request)
        {
            ...
            return Ok(APIResponse<string>.Builder()
                .WithStatusCode(HttpStatusCode.OK)
                .WithSuccess(true)
                .WithResult("Công việc đã được kiểm duyệt thành công")
                .Build());
        }
        ...
        public async Task<IActionResult> DeleteJob(int id)
        {
            ...
            return Ok(APIResponse<string>.Builder()
                .WithStatusCode(HttpStatusCode.OK)
                .WithSuccess(true)
                .WithResult("Xóa job thành công. Tất cả các ứng viên đã được xử lý và thông báo đã được gửi.")
                .Build());
        }
