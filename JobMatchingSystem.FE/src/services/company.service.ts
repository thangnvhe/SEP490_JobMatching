...
export const CompanyServices = {
  getAll: (params?: Record<string, any>) => BaseApiServices.getAll<Company[]>('/Company/all', params),
  getAllCompaniesWithPagination: (params: PaginationParamsInput) => BaseApiServices.getAllWithPagination<Company>('/Company', params),
  ...
  getCompanyMe: () => BaseApiServices.custom<BaseResponse<Company>>("get", "/Company/me"),
};