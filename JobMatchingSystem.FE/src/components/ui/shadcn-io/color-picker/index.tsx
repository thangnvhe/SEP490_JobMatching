...
export const ColorPicker = ({
  ...
  const [hsl] = initialColor.hsl().array();
  ...
  // Notify parent of changes - chỉ trong uncontrolled mode để tránh vòng lặp vô hạn
  // Trong controlled mode, onChange sẽ được gọi trực tiếp từ ColorPickerDialog khi cần
  useEffect(() => {
    if (onChange && !isControlled) {
      // Chỉ gọi onChange trong uncontrolled mode
      try {
  ...
  }, [hue, saturation, lightness, alpha, onChange, isControlled]);
