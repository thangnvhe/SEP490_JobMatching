      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center bg-gray-50 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-sm text-center max-w-md w-full border">
          ...
          <p className="text-gray-500 mb-8">
            {error || "Công ty này không tồn tại hoặc đã bị xóa."}
          </p>
          <Button
            onClick={() => navigate(getBackPath())}
            variant="ghost"
            className="w-full text-emerald-600 hover:bg-emerald-600 hover:text-white pl-0 cursor-pointer"
          >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3 mt-3 text-gray-600">
                  <Badge
                    ...
                    className={`${statusInfo.className} px-3 py-1 rounded-full font-medium`}
                  >
              ...
              <div className="flex items-center gap-3 mt-2 md:mt-0">
                ...
                {company.email && (
                  <Button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 shadow-sm shadow-emerald-200 transition-all duration-200"
                  >
            ...
            <Tabs defaultValue="about" className="w-full">
              <TabsList className="w-full h-auto p-1 bg-emerald-50/50 border border-emerald-100 rounded-xl gap-2 mb-6">
                ...
                >
                  ...
                  <Badge
                    variant="secondary"
                    className="ml-2 bg-emerald-100 text-emerald-700 group-data-[state=active]:bg-emerald-50"
                  >
                ...
                {jobsLoading ? (
                  <div className="grid grid-cols-1 gap-4">
                    {[1, 2, 3].map((i) => (
                      <Card
                        key={i}
                        className="p-6 border border-gray-100 shadow-sm"
                      >
                  ...
                  <Card className="border-dashed border-2 bg-gray-50/50">
                    <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                      ...
                      <p className="text-gray-500 mt-1 max-w-xs">
                        Hiện tại công ty chưa đăng tải vị trí tuyển dụng nào.
          ...
          <div className="space-y-6">
            ...
            <Card className="border-none shadow-sm bg-white sticky top-24">
              ...
              <CardFooter className="bg-gray-50/30 p-4 border-t">
                <Button
                  variant="outline"
                  className="w-full gap-2 text-emerald-600 hover:bg-emerald-600 hover:text-white hover:border-emerald-600"
                  onClick={() => {
