...
export default function CandidateViewReportList() {
  ...
  // Fetch reports with server-side pagination and filtering - Using getReportForCandidate
  const getAllWithPagination = useCallback(async (params: PaginationParamsInput) => {
    try {
      ...
      // Gọi API getReportForCandidate thay vì getAllWithPagination
      const response = await ReportService.getReportForCandidate(requestParams);
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground">Xem và theo dõi các báo cáo bạn đã gửi về công việc</p>
      </div>
      {/* Search and Actions */}
      <Card>
        <CardHeader>
